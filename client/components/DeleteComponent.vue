      ...
      <div class="form-wrapper">
        ...
        <form>
          ...
          <div class="form-entry">
            <div class="label-div">
              <custom-button class="custom-button" info="/" v-on:customClick="deleteVehicle" ></custom-button><input type="text" id="vehicleid" v-model="form.vehicleId" >
            </div>
            <div class ="label-div">
              /api/vehicles/:id  -   Delete vehicle with id
            </div>
          </div>
  ...
  methods: {
    ...
    deleteVehicle() {
      if (!this.form.vehicleId) {
        this.display_message = "Cannot delete Empty values"
