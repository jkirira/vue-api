  ...
  <div main>
    ...
    <form>
      ...
      <div class="form-entry">
        <div class="label-div">
          <custom-button class="custom-button" info="/:id" v-on:customClick="fetchVehicle" ></custom-button>
        </div>
        <div class ="label-div">
          <input type="text" id="vehicleid" v-model="form.vehicleId" >
        </div>
      </div>
    ...
    <div class="entry">
      <custom-button info="Edit Task" v-on:customClick="editVehicle" ></custom-button>
    </div>
...
export default {
  ...
  methods: {
    ...
    editVehicle() {
      ...
      axios.put(URL, {'id': this.form.vehicleId, 'name': this.form.name, 'wheels': this.form.wheels, 'color': this.form.color, 'capacity': this.form.capacity })
          .then((response)=> {
